...
public final class tinsert2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("             <table  align=\"center\" style=\"font-family:cambria;font-size:30\">\n");
      out.write("                 \n");
    ...
    try
    {
     ...
     //insert
     String sql="insert into php values("+s_no+",'"+ques+"','"+op1+"','"+op2+"','"+op3+"','"+op4+"','"+ans+"')";
