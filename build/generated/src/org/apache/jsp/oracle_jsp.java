...
public final class oracle_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        \n");
      out.write("         <form name=\"f1\" action=\"resultoracle.jsp\" method=\"post\">\n");
      ...
      out.write("<table width=\"600\" style=\"font-family:cambria; font-size:25px; color:black ;\">\n");
      out.write("    \n");
      ...
      out.write('\n');
		...
		try
		{
			...
			st=con.createStatement();
                        rs = st.executeQuery("select * from oracle");
                           int i=1;
                           while(rs.next())
            {
