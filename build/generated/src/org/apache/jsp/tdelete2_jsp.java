...
public final class tdelete2_jsp extends org.apache.jasper.runtime.HttpJspBase
...
con.close();
    ...
    try
    {
        ...
        st=con.createStatement();
            ...
            st=con.createStatement();
			int res=st.executeUpdate("delete from php where s_no="+no+"");
			if(res!=0)
				response.sendRedirect("tinsert2.jsp");
			else
