...
<html>
    ...
    <body background="l7.jpg">
        ...
        <table width ="100%" bgcolor="black"> 
            <tr> 
                <td> <font face="cambria" color="white" size="7" >Design Test!</font></td>
            </tr>
    ...
    background:aliceblue;
        ...
        <table  width ="440" height="900"  >
            ...
            <tr>
                <td style="position:fixed; left:520px; top:390px; "><h2><u><a href="tdelete.jsp" style="color:dodgerblue">Java 2016</a></u></h2></td>
            
                <td style="position:fixed; left:720px; top:390px;"><h2><u><a href="tdelete2.jsp" style="color:dodgerblue">Php 2016</a></u></h2></td>
            </tr>
            ...
            <tr>
                <td style="position:fixed; left:500px; top:600px; color:dodgerblue;"><h2><u><a href="tdelete3.jsp" style="color:dodgerblue">JavaScript 2016</a></u></h2></td>
                <td style="position:fixed; left:700px; top:600px; color:dodgerblue;"><h2><u><a href="tdelete4.jsp" style="color:dodgerblue">Oracle 2016</a></u></h2></td>
